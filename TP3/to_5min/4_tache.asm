...
one:    cmp bl, 0H                          ; COMPARER LA VALEUR DE BL AVEC 0H
        jne two                             ; SI BL > 0, SAUTER VERS L'ETIQUETTE two
            ...
            jnge zero                       ; SI BH <= 1, SAUTER VERS L'ETIQUETTE zero
                ...
                inc cpt_exit                ; INCREMENTER cpt_exit
...
start:
    ...
    to_5min:
           ...
           cmp cpt_exit, 100    ; COMPARER LA VALEUR DE cpt_exit ET 60
           jnl exit             ; SI cpt_exit = 60 (5 MINUTES SE SONT ECOULES), SAUTER A L'ETIQUETTE exit POUR SORITR DU PROGRAMME
    ...
    encore:    loop encore      ; FAIRE UNE LOOP SUR L'ETIQUETTE encore
            ...
            jmp to_5min         ; PUIS ON SAUTE VERS L'ETIQUETTE to_5min POUR REINITIALIZER LES COMPTEURS
